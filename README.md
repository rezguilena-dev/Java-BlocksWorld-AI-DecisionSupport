...
Ce projet consiste en une implémentation d'un système décisionnel appliqué au domaine du Monde des Blocs (Blocks World), capable de modéliser des états formels , de calculer des séquences de déplacements optimaux et de résoudre des problèmes de satisfaction de contraintes (CSP). Le projet inclut un module d'extraction de connaissances, capable d'analyser des bases de données d'états afin d'identifier des motifs récurrents et des règles d'association.
